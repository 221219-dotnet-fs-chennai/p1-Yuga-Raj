...
namespace User 
{
    ...
    public class AddCompany
    {
        public void CompanyAdder(int usid)
        {
            ...
            string skill_name = sq.SqlQueryWriterSkill($"Insert into project.comp(about,comp_name,start_date,end_date,us_id) Values('{CompAbout}','{CompName}','{CompStart}','{CompEnd}',{usid});");
            skill_name = sq.SqlQueryWriterSkill($"SELECT * from project.comp;");
    ...
    public class UpdateCompany
    {
        public void CompanyUpdate(int usid)
        {
            ...
            DataTable reader = sq.SqlQeryWriterSkillUpdate($"select k.comp_id,k.comp_name,k.about,k.start_date,k.end_date from project.comp as k WHERE k.us_id = {usid};");
            ...
            sq.sqlQueryDelete($"UPDATE project.comp SET about = '{resabout}', comp_name = '{resname}', start_date = '{resstart}', end_date = '{resend}' WHERE skill_id = {res};");
    ...
    public class DeleteCompany
    {
        public void CompanyDelete(int usid)
        {
            ...
            sq.sqlQueryDelete($"DELETE FROM project.comp WHERE comp_id ={skill_id}");
