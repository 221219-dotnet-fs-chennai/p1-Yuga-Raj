...
namespace User 
{
    ...
    public class AddEdu
    {
        ...
        public void EduAdder(int usid) 
        {
            ...
            string skill_name = sq.SqlQueryWriterSkill($"INSERT INTO project.edu(institution_name,course_name,[start_date],[end_date],cgpa,us_id) VALUES('{EduName}','{EduCourse}','{EduStartDate}','{EduEndDate}','{EduCgpa}',{usid});");
            skill_name = sq.SqlQueryWriterSkill($"SELECT * from project.edu;");
            ...
            //VALUES('full stack developer', 10, 3);
    ...
    public class UpdateEdu 
    {
        public void EduUpdate(int usid)
        {
            ...
            DataTable reader = sq.SqlQeryWriterSkillUpdate($"select edu_id,institution_name,course_name,start_date,end_date,cgpa from project.edu  WHERE .us_id = {usid};");
            ...
            sq.sqlQueryDelete($"UPDATE project.edu SET institution_name = '{resname}',course_name = '{rescourse}',start_date = '{resstartdate}',end_date = '{resenddate}',cgpa = '{rescgpa}' WHERE edu_id = {res};");
    ...
    public class DeleteEdu
    {
        public void EduDelete(int usid)
        {
            ...
            sq.sqlQueryDelete($"DELETE FROM project.edu WHERE edu_id ={skill_id}");
