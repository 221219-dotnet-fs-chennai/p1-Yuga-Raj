...
public class Login
{
    ...
    public int LoginSubmit(string EmailID, string Password)
    {
        ...
        var query = from b in YugrajContext.Users where b.EmailId == EmailID && b.Password == Password select b;
    ...
    public int SignUpSubmit(UserModel user)
    {
        ...
        YugrajContext.Users.Add(user1);
        int i = YugrajContext.SaveChanges();
        return i;
    }
    ...
    public IQueryable<DataEf.Entities.User> SignUpUser()
    {
        ...
        var query = from b in YugrajContext.Users select b;
    ...
    public IList getUser(int id)
    {
        ...
        var query = (from st in YugrajContext.Users
                     where st.UserId == id
                     select st).ToList();
