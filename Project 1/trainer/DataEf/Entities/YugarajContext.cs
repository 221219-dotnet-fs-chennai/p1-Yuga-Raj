...
public partial class YugarajContext : DbContext
{
    public YugarajContext()
    {
    }

    public YugarajContext(DbContextOptions<YugarajContext> options)
        : base(options)
    {
    }
    ...
    string conn = File.ReadAllText(@"C:\Users\SURYA\Training\sqlid.txt\");
